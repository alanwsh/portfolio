...
export default function VirtualKeyboard({ onKeyPress, charactersOnly = false, disabledCharacters = [], disabledAll = false }: { charactersOnly?: boolean, onKeyPress: (key: string) => void, disabledCharacters?: Array<string>, disabledAll?: boolean }) {
    const keys = [
        ['Q', 'W', 'E', 'R', 'T', 'Y', 'U', 'I', 'O', 'P'],
        ['A', 'S', 'D', 'F', 'G', 'H', 'J', 'K', 'L'],
        ['Z', 'X', 'C', 'V', 'B', 'N', 'M'],
    ...
    return (
        <div>
            {
                !charactersOnly && <div className="flex justify-end pr-8">
